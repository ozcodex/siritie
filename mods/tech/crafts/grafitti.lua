...
crafting.register_recipe({
	...
	items = { "tech:crushed_lime", "tech:stick", "group:fibrous_plant 4", "tech:vegetable_oil 2" },
	level = 1,
	always_known = true,
})
...
crafting.register_recipe({
	...
	items = { "group:bioluminescent 16", "tech:stick", "group:fibrous_plant 4", "tech:vegetable_oil 2" },
	level = 1,
	always_known = true,
})
...
crafting.register_recipe({
	...
	items = { "tech:crushed_charcoal_block", "tech:stick", "group:fibrous_plant 4", "tech:vegetable_oil 2" },
	level = 1,
	always_known = true,
})
...
crafting.register_recipe({
	...
	items = { "tech:crushed_iron_ore", "tech:stick", "group:fibrous_plant 4", "tech:vegetable_oil 2" },
	level = 1,
	always_known = true,
})
