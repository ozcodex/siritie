...
## [2023-05-26] 0.4.1
  - Code Refactor
  - Expand traits in character Tab
  - Introduce specialized roof ridge tiles
  - Utilize digging stick for path creation instead of agricultural soil
  - Enhance alembic with alcohol extraction capability
  - Implement Wiha fermentation process for sugar and vinegar production
  - Eliminate slag stairs and slabs due to their lack of usefulness
  - Remove boulders from built blocks since soome actions are irreversible
  - Replace mixing spot with craftable crafts (mixing bucket and masonry toolset)
  - Introduce new craft station: wattlework station
  - Organize tech and textures folder with consistent naming convention
  - Enable composting of meats and cooked food and change composter output from loam to silt
  - Utilize groups for define the amount of compost generated by the composter
  - Introduce clay mixing bucket to undo unfired pottery
  - Enable oil extraction from maraka nut
  - Introduce pottery wheel as an improved clay shaping spot
  - Offer alternative hammering log made from granite
  - Introduce fishtrap tool to automatically catch fishes in the sea
  - Implement clay smoker for bulk cooking
  - Add amphora for tang and wiha cider
  - Implement ceramic pendulum seismograph inspired by Zhang Heng's Seismoscope
  - Introduce alchemy ceramic equipment: Alchemy Mortarium, Elemental Crucible
  - Add alchemy glass equipment: Retort and Vessel
  - Create alchemy bench from alchemy equipement and add alchemy recipes
  - Introduce aluminium as material
  - Add aluminium windows and water containers
